...
public sealed class EntityFrameworkCacheOptions : IOptions<EntityFrameworkCacheOptions>
{
    ...
    /// </summary>
    public TimeSpan ExpiredItemsDeletionInterval { get; set; } = EFCacheHelpers.ExpiredItemsDeletionInterval;
    ...
    /// </summary>
    public TimeSpan DefaultSlidingExpiration { get; set; } = EFCacheHelpers.DefaultSlidingExpiration;
